...
<div class="text" style="padding: 0 2em;">
  <h2>Order Recived </h2>
  <p>Order recived with order number #{{isset($details['rowTransData'])?$details['rowTransData']['trans_order_number']:''}} </p> 
<p>From {{isset($details['rowTransData'])?$details['rowTransData']['trans_user_name']:''}}</p>
